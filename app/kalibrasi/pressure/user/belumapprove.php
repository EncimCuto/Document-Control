...
$sql = "
    SELECT id, tanggal_dibuat, kode_alat, app1, app2, app3, app4, NULL AS extra_column FROM pressure_handover WHERE 1
    UNION
    SELECT id, tanggal_dibuat, kode_alat, app1, app2, app3, app4, NULL AS extra_column FROM temprature_handover WHERE 1
    UNION
    SELECT id, tanggal_dibuat, kode_alat, app1, app2, app3, app4, NULL AS extra_column FROM instrument_handover WHERE 1
    UNION
    SELECT id, tanggal_dibuat, kode_alat, app1, app2, app3, app4, NULL AS extra_column FROM volumetrik_handover WHERE 1
    UNION
    SELECT id, tanggal_dibuat, kode_alat, app1, app2, app3, app4, NULL AS extra_column FROM balance_handover WHERE 1
";
