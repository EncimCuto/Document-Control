        ...
        <div class="fill">
            <div class="dread">
                <div class="crumb">
                    ...
                    <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover"
                        href="../../../maintenance.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">>MAINTENANCE</a>
                    <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover"
                        href="../dashboard.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">> MOTOR PUMP</a>
                    <a class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover"
                        href="approved.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>">> APPROVED</a>
                </div>
            </div>
            <div class="page">
                <a href="./teknisi/belumapproved.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>"
                    class="link-dark link-underline link-underline-opacity-0">
                    <div class="box">
                        <img src="../../../../assets/user/teknisi.png" alt="teknisi" width="140px">
                        <div class="name">TEKNISI</div>
                    </div>
                </a>
                <a href="list_pdf.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
                    <div class="box">
                        <img src="../../../../assets/user/staff.png" alt="staff" width="140px">
                        <div class="name">STAFF</div>
                    </div>
                </a>
                <a href="./approved/approved.php?token=<?php echo htmlspecialchars($_SESSION['token']); ?>" class="link-dark link-underline link-underline-opacity-0">
                    <div class="box">
                        <img src="../../../../assets/user/user.png" alt="user" width="140px">
