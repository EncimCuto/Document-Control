...
<body>
    ...
    <div class="box">
        <a href="sudahapprove.php?username=<?php echo htmlspecialchars($_GET['username'] ?? ''); ?>&bagian=<?php echo htmlspecialchars($_GET['bagian'] ?? ''); ?>&token=<?php echo htmlspecialchars($_SESSION['token'] ?? ''); ?>"><button class="btn ">Back</button></a>
    </div>
    </div>
    </div>
